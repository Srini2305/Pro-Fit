...
def generate_summary(original, lst, top_n, features):
    ...
    valid_words = []
    for each in b:
        for temp in each.split(" "):
            if temp not in stop_words:
                valid_words.append(temp.replace(",","").replace(".",""))
...
class ProFit():
    ...
    def __init__(self):
        ...
        self.access_token = '3033103218-GWAtzb6yfQD9wepHpsQ9HoqKOUXN6prqVRhCfPV'
        self.access_token_secret = 'yzLjpZlmDvK04FhZFe6CoVYPpXCKPyZU56ekGhcwSFVQW'
